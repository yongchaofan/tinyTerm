...
<table>
	<tr>
		...
		<h3>Installation: </h3>
	<a href="https://www.microsoft.com/store/apps/9NXGN9LJTL05">&nbsp&nbsp&nbsp&nbspMicrosoft Store</a><br/><br/>
		<h3>Portable app:</h3>
	32-bit:<a href="https://github.com/yongchaofan/tinyTerm/releases/download/1.2/tinyTerm.exe">&nbsp&nbstinyTerm.exe</a><br/>
	64-bit:<a href="https://github.com/yongchaofan/tinyTerm/releases/download/1.2/tinyTerm64.exe">&nbsp&nbstinyTerm64.exe</a>
	    </td>
	    <td>
