...
<h4>Stable release: <a href="https://github.com/yongchaofan/tinyTerm/releases">1.9.8</a></h4>
<h4>Download: <a href="https://www.microsoft.com/store/apps/9NXGN9LJTL05">Microsoft Store</a>
32-bit: <a href="https://github.com/yongchaofan/tinyTerm/releases/download/1.9.8/tinyTerm.exe">tinyTerm.exe</a>
64-bit: <a href="https://github.com/yongchaofan/tinyTerm/releases/download/1.9.8/tinyTerm64.exe">tinyTerm64.exe</a></h4>
