//
// "$Id: tiny.c 30787 2018-09-30 21:05:10 $"
//
...
\tBy yongchaofan@gmail.com		10-08-2018\r\n\r\n";
...
{
	term_Disp("\033[32mConnecting...\033[37m");
	...
	case WM_PAINT: 
		...
		if ( bFocus ) { 
			if ( bCursor ) {
				...
				wchar_t buf[1024];
				int cch = MultiByteToWideChar(CP_UTF8,0,buff+line[cursor_y],
